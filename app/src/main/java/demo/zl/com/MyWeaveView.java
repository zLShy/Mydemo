...
public class MyWeaveView extends View {
//    private DrawFilter mDrawFilter;
    ...
    public MyWeaveView(Context context) {
        super(context);
        init();
    }

    public MyWeaveView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MyWeaveView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
